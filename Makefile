...
FOCUSED_CRATES := use-diagnostic-code use-diagnostic-level use-diagnostic-message use-diagnostic-span use-diagnostic-label use-diagnostic-report
FACADE_CRATE := use-diagnostic
